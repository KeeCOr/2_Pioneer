...
- 이미지/스프라이트: `src/assets/frames/modal-nautical.svg`, `src/assets/map/world-landmasses.png`
...
![2_Pioneer modal-nautical](../src/assets/frames/modal-nautical.svg)
- `src/assets/frames/modal-nautical.svg`
